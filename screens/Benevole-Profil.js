			...
			<ScrollView>
				...
				>
					<View style={styles.container1}>
						<Text style={styles.txtdate}>Date: 23/12/2022</Text>
					...
					<View style={styles.container3}>
						<Text style={styles.txt}>Nom: Arthuys</Text>
						<Text style={styles.txt}>Prenom: Ruben</Text>
						<Text></Text>
						<Text style={styles.txt}>ID: 01</Text>
						<Text style={styles.txt}>Rang: 00</Text>
					</View>
